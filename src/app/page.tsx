      ...
      <header className="z-[50] sticky top-0 w-full bg-background/95 border-b backdrop-blur-sm dark:bg-black/[0.6] border-border/40">
        <div className="container h-14 flex items-center">
          ...
          >
            ...
            <span className="font-bold">sistema de gerenciamento</span>
            <span className="sr-only">sistema de gerenciamento</span>
          </Link>
          <nav className="ml-auto flex items-center gap-2">
            <Button
              ...
              asChild
            >
              <Link href="https://github.com/KaioYuri/frontend">
          ...
          <section className="mx-auto flex max-w-[980px] flex-col items-center gap-2 py-8 md:py-12 md:pb-8 lg:py-24 lg:pb-6">
            ...
            <div className="flex flex-col md:flex-row w-full items-center justify-center space-y-2 md:space-y-0 md:space-x-4 py-4 md:pb-6">
              ...
              <Button variant="outline" asChild>
                <Link
                  href="https://github.com/KaioYuri/sistema-gerenciamento"
                  target="_blank"
      ...
      <footer className="py-6 md:py-0 border-t border-border/40">
        <div className="container flex flex-col items-center justify-center gap-4 md:h-24 md:flex-row">
          <p className="text-balance text-center text-sm leading-loose text-muted-foreground">
            Construido por{" "}
            <Link
              href="https://kaioyuri.vercel.app"
              target="_blank"
              rel="noopener noreferrer"
